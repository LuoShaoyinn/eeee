...
Options parse_options(int argc, char** argv) {
    ...
    options.search.cargo_calibration_x_m = config.search_cargo_calibration_x_m;
    options.search.cargo_calibration_y_m = config.search_cargo_calibration_y_m;
    options.search.cargo_calibration_stop_radius_m = config.search_cargo_calibration_stop_radius_m;
