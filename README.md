...
L298N, not `raw M DUTY`: its L298N header uses GPIO16 `ENA`, GPIO14 `IN1`, and
GPIO12 `IN2`. Use `ga25 DUTY` for its signed open-loop PWM command. Its encoder
is intentionally unused. Run `python3 tools/keyboard_drive.py --ga25 --host
