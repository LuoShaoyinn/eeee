...
S3 is a standard positional MG995 on GPIO17. At boot and after `stop`, PWM is
disabled, so a reset cannot move or hold a blocked linkage.
...
the most recently applied angle, target angle, 1,550-2,125 us pulse width,
...
map and applies an immediate 1550-2125 us pulse at 50 Hz. Increase it in small
...
body command. It is conservatively limited to `+/-1.00 m/s` forward/strafe and
